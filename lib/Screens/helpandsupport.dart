...
class _HelpnSupportState extends State<HelpnSupport> {
  ...
  Widget build(BuildContext context) {
    ...
    color: Colors.black, //change your color here
         ...
         title: Text('Help & Support',style: GoogleFonts.poppins(color:Colors.black,fontWeight: FontWeight.w700)),backgroundColor: Colors.white,elevation: 0,centerTitle: true,),
      body: SingleChildScrollView(child: SafeArea(child: Padding(
        padding: const EdgeInsets.all(5.0),
        child: Text(data,style: GoogleFonts.poppins(fontWeight:FontWeight.w500,fontSize: 15)),
      )))
