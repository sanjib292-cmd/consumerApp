                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage('images/notserving.jpg'))),
                    ),
                  ),
                  Text("Nearby restaurants not serving ${widget.appBartitle}..",
                    ...
                    Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (con, ind) {
                              ...
                              if (widget
                                      .product[indexofRestro]['items'].length ==
                                  0) {
                                return Text('No data');
                              }
                              return Container(
                                                                      ...
                                                                      DialogButton(
                                                                        ...
                                                                        onPressed:isReplace?(){}:
                                                                          ...
                                                                          await cart.addToCart(
                                                                              ...
                                                                              quantity: 1,
                                                                              price: widget.product[indexofRestro]['items'][ind]['price'],
                                                                              token: userId,
